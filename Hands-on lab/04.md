...
1. From the **Environment Details** page, select **Azure Credentials** then click on **Go to LABVM-UniqueId** button to connect to the **SqlServer2008** Virtual Machine.
