...
2. Once connected to the SqlServer2008 VM,s earch for ```sql server``` into  Windows Start menu and select **Microsoft SQL Server Management Studio 17** from the results and open it.
