...
1. From the Environment Details page, select **Azure Credentials** then click on **GO TO SQL2008-uniqueid** button to connect to the **SqlServer2008** Virtual Machine.
