...
1. Go to PowerApp web portal and sign up for a new account, using the same account you have been using in Azure. You can copy paste the below url in your LabVM browser and signup.
   ```
