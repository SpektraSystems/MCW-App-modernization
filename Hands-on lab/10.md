...
2. Copy and paste the below url in your LabVM browser and signup.
...
1. From the PowerApps website homepage, click on **+Create**.

   ![](media/ap2.png)

2. A new tab will open. Select **New** on the left-hand side click the right arrow denoting **other data sources** next to the **Start with your data** list.
